...
Page({
  ...
  bindPhoneInput: function(e) {
    ...
    if (app.checkPhone(e.detail.value) && !isCaling) {
  ...
  getSmsCodeTap: function(e) {
    ...
    var param = 'phone=' + this.data.phone + '&type=1' + '&openId=' + app.globalData.openId + '&from=2'; //type:1注册，2登录，3修改密码，4信息变更
    that.setData({
      disabledSmsCode: true
    });
          ...
          success: res => {
            ...
            app.getOpenIdHttps(res.code, 0, function(isSuccess, resultData) {
              if (isSuccess) {
                ...
                param.openId2 = resultData.openid; //openid
                param.unionId = resultData.unionid; //openid
