...
* 使用： 1、引入util.js(路径更改) :const util  = require('../../utils/util.js'); 2、util.baseEncode('base64 编码');
*/
...
/*
  * base64解码函数封装
  * @parm: str(传入要解为正常字体)
  * 使用： 1、引入util.js(路径更改) :const util  = require('../../utils/util.js'); 2、util.baseDecode(util.baseEncode('base64 编码'))
*/
function baseDecode(str) {
  return base64_decode(str);
}

function openMapLocation(lat, lon, name, address, scale){
  ...
  if (scale == undefined || scale == null || scale == '' || Number(scale) > 18){
    scale=18;
  }
